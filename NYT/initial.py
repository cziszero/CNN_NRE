...
def get_time(st):
	try :
		...
		print(st+time.strftime(" %a %b %d %H:%M:%S %Y", time.localtime()))
		return time.time()

t0 = get_time("initial.py start ")
...
t1 = get_time("initial.py end ")
print("initial.py spend %d secends"%(t1-t0))